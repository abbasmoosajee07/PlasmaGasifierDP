...
ultimate_analysis <- data.frame(
  ...
  Ash = c(0.12, 0.22, 0.36, 0.22, 9.11, 6.83, 0.23)/100,
  Carbon = c(85.60, 86.98, 86.87, 91.56, 37.24, 63.94, 87.75)/100,
  Hydrogen = c(13.40, 12.12, 12.50, 7.80, 4.99, 4.52, 11.46)/100,
  Nitrogen = c(0.26, 0.27, 0.28, 0.15, 0.08, 0.01, 0.24)/100,
  Sulfur = c(0.00, 0.07, 0.03, 0.04, 0.08, 0.04, 0.04)/100,
  Oxygen = c(0.74, 0.56, 0.32, 0.45, 0.00, 31.49, 0.52)/100,
